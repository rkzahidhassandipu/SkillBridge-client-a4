...
const RATING_CONFIG = [
  null,
  { label: "Poor",      color: "text-red-500",    bg: "bg-red-50",    border: "border-red-200",      badge: "bg-red-100 text-red-700 border-red-200",          bar: "bg-red-400"    },
  { label: "Fair",      color: "text-orange-500",  bg: "bg-orange-50", border: "border-orange-200",   badge: "bg-orange-100 text-orange-700 border-orange-200",  bar: "bg-orange-400" },
  { label: "Good",      color: "text-yellow-500",  bg: "bg-yellow-50", border: "border-yellow-200",   badge: "bg-yellow-100 text-yellow-700 border-yellow-200",  bar: "bg-yellow-400" },
  { label: "Very Good", color: "text-lime-500",    bg: "bg-lime-50",   border: "border-lime-200",     badge: "bg-lime-100 text-lime-700 border-lime-200",        bar: "bg-lime-400"   },
  { label: "Excellent", color: "text-green-500",   bg: "bg-green-50",  border: "border-green-200",    badge: "bg-green-100 text-green-700 border-green-200",     bar: "bg-green-500"  },
];
...
export default function ReviewSection({
  ...
  bookingId,
  tutorName,
  tutorId,      // ✅ Fixed: now properly destructured
  studentId,    // ✅ Fixed: now properly destructured
  onSubmit,
}: ReviewSectionProps) {
  ...
  review?.data.find(r => r.bookingId === bookingId) || null
);
  ...
  /* ─── SUCCESS STATE ─── */
if (currentReview) {
  // Show existing review, hide the form
              ...
              >
                <Star
                  className={cn(
                    ...
                    filled
                      ? cn("fill-current drop-shadow-sm", config?.color ?? "text-gray-300")
